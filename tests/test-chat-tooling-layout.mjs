...
const responsiveSource = readFileSync(join(repoRoot, 'static/frontend/core/layout-tooling.js'), 'utf8');
...
vm.runInNewContext(responsiveSource, mobileHarness.context, { filename: 'static/frontend/core/layout-tooling.js' });
...
vm.runInNewContext(responsiveSource, desktopHarness.context, { filename: 'static/frontend/core/layout-tooling.js' });
