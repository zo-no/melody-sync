...
vm.runInNewContext(composeSource, context, { filename: 'frontend/session/compose.js' });
...
vm.runInNewContext(composeSource, manualContext, { filename: 'frontend/session/compose.js' });
...
vm.runInNewContext(composeSource, legacyContext, { filename: 'frontend/session/compose.js' });
...
vm.runInNewContext(composeSource, standaloneViewportContext, { filename: 'frontend/session/compose.js' });
...
vm.runInNewContext(composeSource, failedSendFocusContext, { filename: 'frontend/session/compose.js' });
...
vm.runInNewContext(composeSource, canonicalSendContext, { filename: 'frontend/session/compose.js' });
...
vm.runInNewContext(composeSource, reloadedPendingSendContext, { filename: 'frontend/session/compose.js' });
...
vm.runInNewContext(composeSource, queuedSendContext, { filename: 'frontend/session/compose.js' });
...
vm.runInNewContext(composeSource, runningTakeoverContext, { filename: 'frontend/session/compose.js' });
...
vm.runInNewContext(composeSource, runningBaselineContext, { filename: 'frontend/session/compose.js' });
...
vm.runInNewContext(composeSource, failedSendContext, { filename: 'frontend/session/compose.js' });
...
vm.runInNewContext(composeSource, suggestionContext, { filename: 'frontend/session/compose.js' });
...
vm.runInNewContext(composeSource, fallbackSuggestionContext, { filename: 'frontend/session/compose.js' });
