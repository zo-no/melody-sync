...
- `local-service/`: local MelodySync service lifecycle scripts
- `voice/`: voice connector, wake/capture helpers, and voice runtime utilities
- `observer/`: proactive observer runtime and helper scripts
- `github-ci/`: GitHub CI auto-repair monitor and service helper scripts
