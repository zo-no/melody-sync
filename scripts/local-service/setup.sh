...
TOKEN_OUTPUT=$(node "$PROJECT_ROOT/generate-token.mjs" 2>&1)
echo "$TOKEN_OUTPUT"
...
<dict>
    ...
    <array>
        ...
        <string>$PROJECT_ROOT/chat-server.mjs</string>
    </array>
...
# Management:
Start services: $PROJECT_ROOT/start.sh
Stop services:  $PROJECT_ROOT/stop.sh
...
echo "  Start: $PROJECT_ROOT/start.sh"
