...
import { normalizeBaseUrl } from './melodysync-http-client.mjs';
...
async function waitForHealthyRelease(options = {}) {
  ...
  const baseUrl = normalizeBaseUrl(options.baseUrl || process.env.MELODYSYNC_CHAT_BASE_URL);
