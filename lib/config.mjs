...
export const HOOKS_FILE = join(configDir, 'hooks.json');
export const GENERAL_SETTINGS_FILE = join(configDir, 'general-settings.json');
export const WORKBENCH_NODE_SETTINGS_FILE = join(configDir, 'workbench-node-settings.json');
export const WORKBENCH_CAPTURE_ITEMS_FILE = join(configDir, 'workbench-capture-items.json');
export const WORKBENCH_PROJECTS_FILE = join(configDir, 'workbench-projects.json');
export const WORKBENCH_NODES_FILE = join(configDir, 'workbench-nodes.json');
export const WORKBENCH_BRANCH_CONTEXTS_FILE = join(configDir, 'workbench-branch-contexts.json');
export const WORKBENCH_TASK_MAP_PLANS_FILE = join(configDir, 'workbench-task-map-plans.json');
export const WORKBENCH_SKILLS_FILE = join(configDir, 'workbench-skills.json');
export const WORKBENCH_SUMMARIES_FILE = join(configDir, 'workbench-summaries.json');
...
export const MEMORY_DIR = resolveOverridePath(process.env.REMOTELAB_MEMORY_DIR)
  || (INSTANCE_ROOT ? join(INSTANCE_ROOT, 'memory') : inferredUserMemoryDir);
