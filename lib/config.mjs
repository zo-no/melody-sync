...
export const CHAT_SESSIONS_DB_FILE = USE_APP_ROOT_STORAGE ? join(dirname(vaultPaths.chatSessionsFile), 'sessions.db') : join(CONFIG_DIR, 'sessions.db');
...
export const TASK_OPS_LOG_FILE = USE_APP_ROOT_STORAGE ? join(vaultPaths.logsDir, 'task-ops.jsonl') : join(CONFIG_DIR, 'task-ops.jsonl');
