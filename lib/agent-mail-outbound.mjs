...
function sendAppleMailMessage(prepared, options = {}) {
  ...
  const script = [
    'set recipientText to system attribute "MELODYSYNC_MAIL_TO"',
    'set subjectText to system attribute "MELODYSYNC_MAIL_SUBJECT"',
    'set bodyText to system attribute "MELODYSYNC_MAIL_TEXT"',
    'set desiredAccount to system attribute "MELODYSYNC_MAIL_ACCOUNT"',
    'set desiredSender to system attribute "MELODYSYNC_MAIL_SENDER"',
  ...
  const result = spawnSync('osascript', ['-'], {
    ...
    env: {
      ...process.env,
      MELODYSYNC_MAIL_TO: prepared.to.join('\n'),
      MELODYSYNC_MAIL_SUBJECT: prepared.subject,
      MELODYSYNC_MAIL_TEXT: prepared.text,
      MELODYSYNC_MAIL_ACCOUNT: prepared.account,
      MELODYSYNC_MAIL_SENDER: prepared.from,
    },
  });
