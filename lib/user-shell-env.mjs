...
const SHELL_ENV_EXPORT_B64 = 'MELODYSYNC_USER_SHELL_ENV_B64';
const SHELL_ENV_START_MARKER = '__MELODYSYNC_SHELL_ENV_START__';
const SHELL_ENV_END_MARKER = '__MELODYSYNC_SHELL_ENV_END__';
...
function pickShellExecutable() {
  const candidates = [
    process.env.MELODYSYNC_USER_SHELL,
    process.env.SHELL,
    DEFAULT_SHELL,
    '/bin/sh',
  ];
