...
export async function runSessionSpawnCommand(argv = [], io = {}) {
  ...
  if (!options.sourceSessionId) {
    throw new Error('No source session id provided. Pass --source-session or set MELODYSYNC_SESSION_ID.');
  }
