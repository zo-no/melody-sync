...
- only the icons currently used in the UI are shipped in `static/frontend/core/icons.js`
...
- centralize the icon registry further if future UI surfaces outside backend/share start reusing the same icon language
