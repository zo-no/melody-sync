...
(function attachMelodySyncI18n(root) {
  ...
  const translations = {
    en: {
      ...
      "sidebar.tasks.controlPanel": "Global Task Console",
      "sidebar.tasks.allCompleted": "All completed",
      "sidebar.project.controlPanel": "Project Console",
      "sidebar.project.unaffiliatedControlPanel": "Task Console",
    ...
    "zh-CN": {
      ...
      "sidebar.tasks.controlPanel": "全局任务控制台",
      "sidebar.tasks.allCompleted": "全部已完成",
      "sidebar.project.controlPanel": "项目控制面板",
      "sidebar.project.unaffiliatedControlPanel": "控制面板",
