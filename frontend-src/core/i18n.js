...
(function attachMelodySyncI18n(root) {
  ...
  const translations = {
    en: {
      ...
      "sidebar.clearArchivedConfirm": "Permanently delete all {count} archived tasks? This cannot be undone.",
      ...
      "sidebar.tab.folders": "Tasks",
      "sidebar.tab.longTerm": "Projects",
      ...
      "sidebar.longTerm.empty": "No long-term tasks yet",
    ...
    "zh-CN": {
      ...
      "sidebar.clearArchivedConfirm": "永久删除全部 {count} 条归档任务？此操作不可恢复。",
      ...
      "sidebar.tab.folders": "任务",
      "sidebar.tab.longTerm": "项目",
      ...
      "sidebar.longTerm.empty": "还没有长期任务",
