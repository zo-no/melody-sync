...
(function attachMelodySyncI18n(root) {
  ...
  const translations = {
    en: {
      ...
      "sidebar.sortList.runTemplate": "AI Group by Your Folders",
      ...
      "sidebar.sortList.configureTemplate": "Create folders first",
      "sidebar.sortList.createFolderFirst": "Create folders first",
      ...
      "sidebar.grouping.user": "User Template",
      "sidebar.grouping.ai": "AI Free",
      "sidebar.grouping.configure": "Edit Template",
      "sidebar.grouping.configureEmpty": "Set Template",
      "sidebar.grouping.createFolder": "Create Folder",
      "sidebar.grouping.deleteFolder": "Delete Folder",
      "sidebar.grouping.saveFailed": "Failed to save the template groups.",
    ...
    "zh-CN": {
      ...
      "sidebar.sortList.runTemplate": "AI 按用户模板分组",
      "sidebar.sortList.runningTemplate": "AI 按你的分组整理中…",
      "sidebar.sortList.doneTemplate": "已按你的分组整理",
      "sidebar.sortList.failedTemplate": "用户分组整理失败",
      "sidebar.sortList.configureTemplate": "先创建分组",
      "sidebar.sortList.createFolderFirst": "先创建分组",
      ...
      "sidebar.grouping.user": "用户模板",
      "sidebar.grouping.ai": "AI 自由",
      "sidebar.grouping.configure": "编辑模板",
      "sidebar.grouping.configureEmpty": "配置模板",
      "sidebar.grouping.createFolder": "创建分组",
      "sidebar.grouping.deleteFolder": "删除分组",
      "sidebar.grouping.saveFailed": "模板分组保存失败。",
