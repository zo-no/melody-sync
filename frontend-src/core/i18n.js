...
(function attachMelodySyncI18n(root) {
  ...
  const translations = {
    en: {
      ...
      "sidebar.longTerm.emptyHint": "Create a project in the Projects tab, or promote a task to a long-term task.",
    ...
    "zh-CN": {
      ...
      "sidebar.longTerm.emptyHint": "在「长期项目」标签页创建项目，或把任务升级为长期任务。",
      ...
      "action.promoteRecurring": "升级为长期任务（循环执行）",
