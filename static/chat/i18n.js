...
(function attachRemoteLabI18n(root) {
  ...
  const translations = {
    en: {
      ...
      "taskBar.label": "Current Task",
      "taskMap.label": "Task Map",
      "taskMap.title": "Task Flow Map",
      "taskMap.note": "Explore the main quest and side quests like a game map.",
      "taskMap.empty": "No side quests yet. Future task routes will appear here.",
      ...
      "sidebar.filter.origin": "Filter tasks by origin",
      "sidebar.filter.app": "Filter tasks by app",
      "sidebar.filter.user": "Filter tasks by user",
      ...
      "sidebar.noSessionsFiltered": "No tasks match the current filters",
      ...
      "settings.users.note": "Create extra identities, choose which apps they can use, pick their language, and seed a first task when they are empty.",
      ...
      "settings.users.defaultStatus": "Admin stays the default view. New users get a starter task automatically.",
      ...
      "settings.users.created": "Created {name}.",
      ...
      "settings.apps.welcomePlaceholder": "Optional first assistant message shown when a new task starts",
      ...
      "settings.apps.defaultStatus": "Create a reusable app here, then start tasks under it from the sidebar filter.",
      ...
      "settings.apps.label.internalStarter": "Internal starter app. Opens owner tasks only.",
      "settings.apps.label.defaultConversation": "Default normal conversation app for everyday MelodySync tasks.",
      "settings.apps.kind.builtin": "Built-in",
      "settings.apps.kind.custom": "Custom",
      "settings.apps.kind.internal": "Internal",
      "settings.apps.copyLink": "Copy",
      ...
      "modal.advancedBody": "If you need models, thinking controls, or custom runtime behavior, open a new task in the MelodySync repo and paste this prompt.",
    ...
    "zh-CN": {
      ...
      "taskMap.label": "任务地图",
      "taskMap.title": "任务流程图",
      "taskMap.note": "像游戏地图一样查看主线与支线",
      "taskMap.empty": "暂无支线，后续任务流程会显示在这里。",
      ...
      "sidebar.filter.origin": "按来源筛选任务",
      "sidebar.filter.app": "按应用筛选任务",
      "sidebar.filter.user": "按用户筛选任务",
      ...
      "sidebar.noSessionsFiltered": "当前筛选条件下没有任务",
      ...
      "settings.users.note": "创建额外身份，配置他们可用的应用和界面语言，并在他们还是空白时自动种下第一个任务。",
      ...
      "settings.users.defaultStatus": "管理员视角仍然是默认视图。新用户会自动获得一个起始任务。",
      ...
      "settings.users.created": "已创建 {name}。",
      ...
      "settings.apps.welcomePlaceholder": "新任务开始时显示的可选首条助手消息",
      "settings.apps.systemPromptPlaceholder": "这个应用的可选系统提示词",
      "settings.apps.create": "创建应用",
      "settings.apps.loading": "正在加载应用…",
      "settings.apps.defaultStatus": "先在这里创建一个可复用应用，然后再通过侧边栏筛选器在该应用下开启任务。",
      ...
      "settings.apps.label.internalStarter": "内部起始应用，仅打开 owner 任务。",
      "settings.apps.label.defaultConversation": "默认普通对话应用，适合日常 MelodySync 任务。",
      "settings.apps.kind.builtin": "内置",
      "settings.apps.kind.custom": "自定义",
      "settings.apps.kind.internal": "内部",
      "settings.apps.copyLink": "复制",
      ...
      "modal.advancedBody": "如果你需要模型、thinking 控制或自定义 runtime 行为，就在 MelodySync 仓库里新开一个任务，把这段提示词贴进去。",
      ...
      "compose.voiceCleanup.on": "开启：发送前会结合当前任务对语音转写做一次隐藏清洗",
