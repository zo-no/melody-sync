...
(function attachRemoteLabI18n(root) {
  ...
  const translations = {
    en: {
      ...
      "settings.apps.label.defaultConversation": "Default normal conversation app for everyday MelodySync sessions.",
      ...
      "modal.advancedBody": "If you need models, thinking controls, or custom runtime behavior, open a new session in the MelodySync repo and paste this prompt.",
    ...
    "zh-CN": {
      ...
      "settings.apps.label.defaultConversation": "默认普通对话应用，适合日常 MelodySync 会话。",
      ...
      "modal.advancedBody": "如果你需要模型、thinking 控制或自定义 runtime 行为，就在 MelodySync 仓库里新开一个会话，把这段提示词贴进去。",
